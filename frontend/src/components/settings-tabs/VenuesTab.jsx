  ...
  const fetchData = async () => {
    ...
    try {
      const [venueRes, equipRes] = await Promise.all([
        api.get("/general/venues").catch(() => api.get("/public/venues")),
        api.get("/general/equipment-types").catch(() => api.get("/public/equipment-types").catch(() => ({ data: [] }))),
      ]);
