export default function Hero() {
  return (
    <section className="text-center mb-10 sm:mb-14 animate-in fade-in slide-in-from-top-5 duration-700 max-w-3xl mx-auto px-4">
      ...
      <p className="text-sm sm:text-base text-slate-500 max-w-xl mx-auto leading-relaxed font-medium text-center tracking-normal">
