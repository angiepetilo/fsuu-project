...
export default function FeatureCards() {
  return (
    <div className="mb-[5rem]">
      {/* Choice Cards Grid */}
      <section className="grid grid-cols-[repeat(auto-fit,minmax(340px,1fr))] gap-[2.5rem] mb-[2rem]">
      ...
      {/* Track Booking Button Below The Two Cards */}
      <div className="flex justify-center my-6">
        <Link
          to="/track"
          className="inline-flex items-center justify-center px-12 sm:px-16 py-3.5 bg-white border-2 border-slate-200 hover:border-blue-600 active:border-blue-700 rounded-2xl text-sm sm:text-base font-extrabold text-slate-800 hover:text-blue-600 active:text-blue-700 shadow-xs hover:shadow-lg hover:shadow-blue-500/15 hover:bg-blue-50/50 active:bg-blue-100/70 active:scale-[0.98] focus:outline-none focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
        >
          Track Booking
        </Link>
      </div>
