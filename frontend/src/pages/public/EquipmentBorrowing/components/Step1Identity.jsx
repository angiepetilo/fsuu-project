  ...
  return (
    <div className="p-6 sm:p-8 animate-in fade-in duration-300 space-y-8">
      ...
      <div className="space-y-3">
        <div className={`grid grid-cols-1 ${isPortal ? "sm:grid-cols-3" : "sm:grid-cols-2 max-w-2xl mx-auto"} gap-6`}>
          <div
      ...
      <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-[#1E2D56]">
        ...
        >
          ...
          <span className="hidden sm:inline">Next: Select Equipment & Quantity</span>
          <ArrowRight size={16} />
        </Button>
      </div>
    </div>
