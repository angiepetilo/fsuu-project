      ...
      <div className="space-y-3">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          <div
            ...
            className={`group bg-white rounded-[24px] p-6 text-center cursor-pointer transition-all duration-300 border-2 flex flex-col items-center justify-center min-h-[190px] ${normIdentity === "student"
          ...
          <div
            ...
            className={`group bg-white rounded-[24px] p-6 text-center cursor-pointer transition-all duration-300 border-2 flex flex-col items-center justify-center min-h-[190px] ${normIdentity === "faculty"
          ...
          <div
            ...
            className={`group bg-white rounded-[24px] p-6 text-center cursor-pointer transition-all duration-300 border-2 flex flex-col items-center justify-center min-h-[190px] ${normIdentity === "external"
