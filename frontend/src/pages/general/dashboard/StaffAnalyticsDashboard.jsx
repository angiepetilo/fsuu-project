...
export default function StaffAnalyticsDashboard({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* 4 Analytics Breakdown Widgets */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* 1. Top Department Bookings */}
        ...
        {/* 4. Top Late Return Department */}
        <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-2xs flex flex-col space-y-3">
          <div className="border-b border-slate-100 pb-2">
            <h3 className="font-extrabold text-slate-900 text-xs tracking-tight">
              Top Late Return Dept.
            </h3>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-4 my-auto text-center">
            ...
            <span className="text-[11px] text-slate-500 font-semibold mt-1">
              Most frequent late check-ins
            </span>
          </div>
        </div>
      </div>

      {/* Borrowers with Late Returns — full width, dynamic */}
