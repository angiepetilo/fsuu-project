...
class SystemSettingController extends Controller
{
     ...
     * Settings endpoint returning full settings including SMTP configuration.
     */
    ...
    /**
     * PUT /api/general/system-settings
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        if (!empty($validated['university_name']) && empty($validated['organization_name'])) {
            $validated['organization_name'] = $validated['university_name'];
        }
        if (!empty($validated['telephone_no']) && empty($validated['contact_phone'])) {
            $validated['contact_phone'] = $validated['telephone_no'];
        }
    ...
    /**
     * POST /api/general/system-settings/test-smtp
